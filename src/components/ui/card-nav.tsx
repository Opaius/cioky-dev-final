      ...
      >
        <div class="absolute inset-x-0 top-0 z-2 flex h-[60px] items-center justify-between p-2 pl-[1.1rem]">
          ...
          >
            <div
              class={cn(
                "h-0.5 w-[30px] origin-[50%_50%] bg-current transition-all duration-300 ease-linear",
                ...
                <div class="mt-auto flex flex-col gap-0.5">
                  <Index each={item().links}>
                    {(link) => (
                      <a
                        href={link().href}
                        class="inline-flex cursor-pointer items-center gap-1.5 text-[15px] no-underline transition-opacity duration-300 hover:opacity-75 md:text-[16px]"
